...
targets (deaths and hospitalizations) and vaccine coverage levels. Any 
...
- Weekly reported state-level incident hospitalizations, will be based on the 
  ...
  [reporting system](https://healthdata.gov/Hospital/COVID-19-Reported-Patient-Impact-and-Hospital-Capa/g62h-syeh). 
